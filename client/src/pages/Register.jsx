        ...
        <div className="flex items-center justify-center min-h-[70vh]">
            <div className="bg-dark-900 border border-dark-700 rounded-2xl p-8 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="register-display-name" className="block text-sm text-dark-400 mb-1">Display Name</label>
                        <input id="register-display-name" type="text" value={form.display_name} onChange={update('display_name')} required
                    ...
                    <div>
                        <label htmlFor="register-username" className="block text-sm text-dark-400 mb-1">Username</label>
                        <input id="register-username" type="text" value={form.username} onChange={update('username')} required
                            className="w-full bg-dark-800 border border-dark-600 rounded-lg px-4 py-2.5 text-dark-100 focus:outline-none focus:border-primary-500 transition" />
                    </div>
                    <div>
                        <label htmlFor="register-email" className="block text-sm text-dark-400 mb-1">Email</label>
                        <input id="register-email" type="email" value={form.email} onChange={update('email')} required
                            className="w-full bg-dark-800 border border-dark-600 rounded-lg px-4 py-2.5 text-dark-100 focus:outline-none focus:border-primary-500 transition" />
                    </div>
                    <div>
                        <label htmlFor="register-password" className="block text-sm text-dark-400 mb-1">Password</label>
                        <input id="register-password" type="password" value={form.password} onChange={update('password')} required minLength={6}
                            className="w-full bg-dark-800 border border-dark-600 rounded-lg px-4 py-2.5 text-dark-100 focus:outline-none focus:border-primary-500 transition" />
                    </div>
