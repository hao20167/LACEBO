        ...
        <div className="flex items-center justify-center min-h-[70vh]">
            <div className="bg-dark-900 border border-dark-700 rounded-2xl p-8 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="login-username" className="block text-sm text-dark-400 mb-1">Username</label>
                    ...
                    <div>
                        <label htmlFor="login-password" className="block text-sm text-dark-400 mb-1">Password</label>
