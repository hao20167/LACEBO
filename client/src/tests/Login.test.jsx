 ...
 *
 * Chiến lược mock:
 *  - useAuth được export từ '../contexts/AuthContext' nhưng file gốc không export
 *    function đó (chỉ export AuthContext context object và AuthProvider).
 *  - Ta mock toàn bộ module để inject useAuth mock có thể điều khiển qua
 *    biến `mockAuthState` được cập nhật trong từng test.
 */
