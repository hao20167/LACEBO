...
> Backend hiện tại sử dụng Node.js, Express và SQLite. Không cần Java, Maven hay PostgreSQL để chạy dự án này.
...
| :--- | :--- | :--- |
| **Hướng dẫn Thế giới** | Thông tin tính năng và roleplay trong thế giới ảo | [Xem tại đây](./docs/world-features-guide.md) |
| **Quản trị Thế giới** | Hướng dẫn quản lý thành viên, bài viết và sự kiện | [Xem tại đây](./docs/world-management.md) |
| **Hướng dẫn UI/UX** | Tiêu chuẩn thiết kế và trải nghiệm người dùng | [Xem tại đây](./docs/ui-ux-guidelines.md) |
| **Bảo mật (Security)** | Quy tắc bảo mật, rate limiting và validation | [Xem tại đây](./docs/SECURITY.md) |
| **Kế hoạch Kiểm thử** | Các kịch bản và chiến lược kiểm thử (Test Plan) | [Xem tại đây](./docs/TEST_PLAN.md) |
| **Hướng dẫn Triển khai** | Quy trình cài đặt, chạy và deploy hệ thống | [Xem tại đây](./docs/deployment-guide.md) |
> *Xem trực quan cấu trúc dữ liệu tại `docs/db_diagram.png`